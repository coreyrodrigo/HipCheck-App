...
def process_image(image_file):
    ...
    if close_side == "left":
        ...
        close_hip_px = to_px(JOINTS["left_knee"])
        ...
        close_hip_px = to_px(JOINTS["right_knee"])
        far_knee_px = to_px(JOINTS["left_knee"])

    close_hip_extension = 180 - close_hip_angle
    far_knee_extension = far_knee_angle - 90
    jurdan_angle = close_hip_extension + far_knee_extension
    ...
    draw_label(f"{close_hip_extension:.1f}", close_hip_px)
    ...
    return close_side, jurdan_angle, (close_hip_extension, far_knee_extension), image_bgr
